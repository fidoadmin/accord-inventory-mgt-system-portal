...
const GenerateBranchGatePassPDF = ({
  companyDetails,
  branchDetails,
  checkoutList,
  date,
              ...
              >
                ...
                <Text
                  style={[
                    ...
                    {
                      fontWeight: "bold",
                      marginLeft: hasPartNumber ? "27%" : "56%",
                    },
                  ]}
                >
...
export default GenerateBranchGatePassPDF;
