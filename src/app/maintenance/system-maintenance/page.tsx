...
import CategoriesMaintenanceContainer from "@/components/Maintenance/Categories/CategoriesMaintenance";
import ContainersMaintenanceContainer from "@/components/Maintenance/Containers/ContainersMaintenance";
import InventoryDescriptionMaintenanceContainer from "@/components/Maintenance/InventoryDescriptions/InventoryDescriptionMaintenance";
...
const SystemMaintenance: React.FC = () => {
  ...
  const componentOptions = [
    {
      Code: "ACCESSLABEL-INVENTORYDESCRIPTION",
      Component: InventoryDescriptionMaintenanceContainer,
    },
    {
      Code: "ACCESSLABEL-CATEGORY",
      Component: CategoriesMaintenanceContainer,
    },
    {
      Code: "ACCESSLABEL-CONTAINER",
      Component: ContainersMaintenanceContainer,
    },
  ];
  ...
  const dropdownsArray = menuItems?.flatMap((menu) =>
    menu.Code === "ACCESSLABEL-MAINTENANCE"
      ? menu.SideBarDropdowns?.flatMap((child: any) =>
          child.Code === "ACCESSLABEL-SYSTEM" ? child.PageDropdowns || [] : []
        )
      : []
  );
